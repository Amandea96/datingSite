				...
				<header id="header" class="alt">
					...
					@else
						...
						<li class="submenu ">
								...
								<ul>
								<li><a href="{{ route('account', ['id' => Auth::user()->id]) }}">Profil</a></li>
									<li><a href="{{ route('showEdit', ['id' => Auth::user()->id]) }}">Edytuj</a></li>
									<li><a href="{{ route('showFriends', ['id' => Auth::user()->id]) }}">Znajomi</a></li>
