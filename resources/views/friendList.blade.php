...
@section('title','Lista Przyjaciół')
...
@section('navigation')
							...
							<li class='current'><a href="{{ route('listPerson.show') }}">Przeglądaj</a></li>
...
@foreach ($myfriends as $mfr)

<section class="boxsh">
							<div>
							<header class="major">
							
								<h2><strong><a href="{{ route('chatting', ['id' => $mfr->id]) }}">{{$mfr->name}}</a></strong></h2>
							...
							<div class="row">
								<div class="col-6 col-12-narrower">
									...
									<section>
										...
										<a href="{{ route('chatting', ['id' => $mfr->id]) }}" class="image featured"><img src="{{$mfr->image}}" alt="" /></a></p>
									</section>
...
@foreach ($myfriends2 as $mfr2)

<section class="boxsh">
							<div>
							<header class="major">
							
								<h2><strong><a href="{{ route('chatting', ['id' => $mfr2->id]) }}">{{$mfr2->name}}</a></strong></h2>
							...
							<div class="row">
								<div class="col-6 col-12-narrower">
									...
									<section>
										...
										<a href="{{ route('chatting', ['id' => $mfr2->id]) }}" class="image featured"><img src="{{$mfr2->image}}" alt="" /></a></p>
									</section>
...
<form method="POST" class="pure-form pure-form-stacked" action="{{ route('searchFriend', ['id' =>  session('iduser')]) }}">
