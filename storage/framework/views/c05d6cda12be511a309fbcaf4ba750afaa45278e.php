<?php $__env->startSection('title','Lista Osób'); ?>
...
<?php $__currentLoopData = $userShow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

<section class="boxsh">
							<div>
							<header class="major">
							
								<h2><strong><a href="<?php echo e(route('account', ['id' => $u->id])); ?>"><?php echo e($u->name); ?></a></strong></h2>
							...
							<div class="row">
								<div class="col-6 col-12-narrower">
									...
									<section>
										...
										<a href="<?php echo e(route('account', ['id' => $u->id])); ?>" class="image featured"><img src="<?php echo e($u->image); ?>" alt="" /></a></p>
									</section>
            ...
            <tr>
                ...
                <td><?php echo e($u->height); ?></td>
							...
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									...
									<?php echo e($userShow->appends(Request::except('page'))->links()); ?>
...
<form method="GET" class="pure-form pure-form-stacked" action="<?php echo e(route('search')); ?>">
